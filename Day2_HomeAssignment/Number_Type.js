...
function Number_Type(value){
    if(value>0){
        return("The Given number "+value+ " is Postive")
    }
    else if(value<0){
        return("The Given number "+value+ " is Negative")
    }
    else{
        return("The Given number is Zero")
    }
}
let result = Number_Type(12)
console.log(result) 
let result1 = Number_Type(-6)
console.log(result1) 
let result2 = Number_Type(0)
console.log(result2) 
